    ...
    >
      <div
        style={{
          position: "absolute",
        inset: 0,
        // Recolored from the pasted component's default blue to the Jejaku
        // mesh palette (cream / amber / teal / seafoam) per DESIGN.md.
        backgroundColor: "#f4faf8",
        backgroundImage:
          "url(\"data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' width='120' height='120'><filter id='n'><feTurbulence type='fractalNoise' baseFrequency='0.9' numOctaves='2' stitchTiles='stitch'/></filter><rect width='100%' height='100%' filter='url(%23n)' opacity='0.500'/></svg>\"), radial-gradient(circle at 67.04% 45.93%, rgba(245, 239, 212, 1) 0%, rgba(245, 239, 212, 0.844) 19.02%, rgba(245, 239, 212, 0.5) 38.05%, rgba(245, 239, 212, 0.156) 57.07%, rgba(245, 239, 212, 0) 76.1%), radial-gradient(circle at 35.47% 65.92%, rgba(232, 163, 61, 1) 0%, rgba(232, 163, 61, 0.844) 12.9%, rgba(232, 163, 61, 0.5) 25.8%, rgba(232, 163, 61, 0.156) 38.7%, rgba(232, 163, 61, 0) 51.6%), radial-gradient(circle at 48.33% 20.11%, rgba(0, 161, 154, 1) 0%, rgba(0, 161, 154, 0.844) 16.75%, rgba(0, 161, 154, 0.5) 33.5%, rgba(0, 161, 154, 0.156) 50.25%, rgba(0, 161, 154, 0) 67%), radial-gradient(circle at 80.81% 88.03%, rgba(127, 224, 196, 1) 0%, rgba(127, 224, 196, 0.844) 10.28%, rgba(127, 224, 196, 0.5) 20.55%, rgba(127, 224, 196, 0.156) 30.83%, rgba(127, 224, 196, 0) 41.1%)",
